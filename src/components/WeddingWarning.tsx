  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(201,99,107,0.6), rgba(201,150,42,0.4), rgba(201,99,107,0.6))',
        }}
      >
        <div
          className="rounded-[1.4rem] px-6 py-8 sm:px-10 sm:py-10 text-center relative overflow-hidden"
          style={{
            background: 'linear-gradient(160deg, #FFF5F5 0%, #FDF8F0 60%, #FFF0F0 100%)',
            border: '2px dashed rgba(201,99,107,0.4)',
          }}
        >
          ...
          {/* Badge */}
          <div
            className="inline-flex items-center gap-1.5 px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.35em] mb-5"
            style={{
              background: 'rgba(201,99,107,0.12)',
              color: '#B04050',
          ...
          <motion.h2
            ...
            style={{
              ...
              lineHeight: 1.55,
              marginBottom: '1rem',
              textShadow: '0 2px 12px rgba(201,39,59,0.18)',
            }}
          >
